...
function loadMap(month) {
	...
	/* Set the chosen month to be the first available on pageload, otherwise set it to the month selected from the menu. */
	var chosenMonth;
	...
	/* Variables to initialise the map, generated by OS Openspace Map Builder. Variable osMap created in OS Openspace file basicmap.js. */
	var options = {resolutions: [2500, 1000, 500, 200, 100, 50, 25, 10, 5, 4, 2.5, 2, 1]};
	osMap = new OpenSpace.Map('routeMap', options);

	/* Object containing the map reference data for each currently available map, data generated by OS Openspace Map Builder and re-organised into objects. */
	var mapData = {
		"nov17": {
